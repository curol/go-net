...
func (m *mock) PostJSONRequest() []byte {
...
func (m *mock) GetRequest() []byte {
	data := "GET / HTTP/1.1\r\nHost: localhost:8080\r\nUser-Agent: curl/7.43.0\r\nAccept: */*\r\n" + CRLF
	return []byte(data)
}

func (m *mock) FileGetRequest() []byte {
	data := "GET /index.html HTTP/1.1\r\nHost: localhost:8080\r\nUser-Agent: curl/7.43.0\r\nAccept: */*\r\n" + CRLF
	return []byte(data)
}

func (m *mock) GetRequestFromFile() io.Reader {
	// Open file
...
func (m *mock) Connection() (net.Conn, net.Conn) {
...
func (m *mock) ReaderFromString(s string) io.Reader {
	return strings.NewReader(s)
}

// MockNewBytesReader returns a new Reader reading from b.
func (m *mock) ReaderFromBytes(b []byte) io.Reader {
	return bytes.NewReader(b)
}

func (m *mock) WriterToBuffer() {
